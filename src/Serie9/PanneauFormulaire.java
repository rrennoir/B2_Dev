...
public class PanneauFormulaire extends JPanel {
    ...
    public void resetFormulaire() {
        ...
        boursierCBox.setSelected(false);
        etrangerCBox.setSelected(false);
        inscrtiptionButton.setSelected(false);
        reinscriptionButton.setSelected(false);
    }

    public void validateFormulaire() {
        Etudiant etu = new Etudiant(matriculeField.getText(), nomField.getText(), prenomField.getText(),
                ddnField.getText(), sectionField.getText(), boursierCBox.isSelected(), etrangerCBox.isSelected(),
                inscrtiptionButton.isSelected(), reinscriptionButton.isSelected());
