 ...
 */
public class TableModelGen extends AbstractTableModel {// Liste des noms de colonnes
	...
	// Retourne la valeur de la cellule � l'intersection de la ligne num�ro "row" et
	// de la colonne num�ro "col"
	...
	/*
	 * Retourne la classe correspondant aux valeurs de la colonne num�ro "c". Cette
	 * m�thode est appel�e entre autres lors de l'affichage des colonnes dans la
	 * JTable afin d'afficher le bon type des colonnes (num�riques align�s � droite,
	 * cha�nes de caract�res align�es � gauche, bool�ens sous forme de cases �
	 * cocher, date avec format de date, ...)
	 */
